 ...
 *     @OA\Property(property="hr_employee_id", type="integer", example=5),
 *     @OA\Property(property="hr_employee_name", type="string", example="HR Manager"),
 *     @OA\Property(property="employee_employee_id", type="integer", example=10),
 *     @OA\Property(property="employee_employee_name", type="string", example="Anonymous Employee"),
