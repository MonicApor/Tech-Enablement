...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by making a POST request to `/oauth/token` with your credentials. Use the `access_token` from the response in the Authorization header as `Bearer {token}`.',
    ],
